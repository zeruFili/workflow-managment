        ...
        {tiles.map((tile) => {
          ...
          return (
            <Link
              key={tile.label}
              to={tile.to}
              className="rounded-2xl border border-slate-200 bg-white p-5 text-left shadow-sm transition hover:-translate-y-0.5 hover:shadow-md hover:ring-2 hover:ring-blue-400"
            >
      ...
      {tasks.map((task) => {
        ...
        return (
          <Link
            ...
            className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm transition hover:shadow-md hover:ring-2 hover:ring-blue-400"
          >
